...
?>
<br/>
<h4><?php echo $artistes[0]['nom']; ?></h4>
    <img class="detailImg zoom" src="<?php echo WEBROOT; ?>images/artiste/<?php echo $artistes[0]['image_artiste']; ?>" title="artiste" alt="<?php echo $artistes[0]['nom']; ?>" >
    <span class="detail" ><?php echo nl2br($artistes[0]['bio']); ?></span>
<br/><br/>
...
<?php if($artistes[0]['id_artiste'] > $id['min']){ ?>
    ...
    <br/><br/>
<?php } ?>
<?php if($artistes[0]['id_artiste'] < $id['max']){ ?>
